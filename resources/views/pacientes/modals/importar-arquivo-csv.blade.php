        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-medium text-gray-900 dark:text-white">
                    Importar pacientes do arquivo CSV
                </h3>
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <form id="form-importar">
                    <div class="flex items-center justify-center w-full">
                        <label for="input-csv" class="flex flex-col items-center justify-center w-full h-56 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            ...
                            <input id="input-csv" name="input-csv" type="file" class="hidden" />
                        </label>
                    </div> 
                </form>
